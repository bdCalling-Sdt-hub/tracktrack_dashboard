...
import { useDeleteFeedbackMutation, useGetTotalFeedBackQuery } from "../../Redux/api/feedBackApis";
...
const Feedback = () => {
    ...
    const { data: feedBackData, isLoading: feedBackLoading, refetch } = useGetTotalFeedBackQuery({ searchTerm, page });
    ...
    const [selectedFeedbackId, setSelectedFeedbackId] = useState<string | null>(null); // Typed selected feedback ID state
